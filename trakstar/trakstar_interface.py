"""TrakSTARInterface"""
import threading
from trakstar import atc3dg_functions as api
...
class TrakSTARInterface(object):
    ...
    def get_synchronous_data_dict(self, write_data_file=True):
        ...
        d["cpu_time"] = cpu_time
        if 1 in self.attached_sensors: #Top camera
        ...
        if 2 in self.attached_sensors: #Probe
        ...
        if 3 in self.attached_sensors: #box
